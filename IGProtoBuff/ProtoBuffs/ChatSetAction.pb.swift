...
struct IGPChatSetAction: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatSetAction"
...
struct IGPChatSetActionResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatSetActionResponse"
...
extension IGPChatSetAction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatSetAction) -> Bool {
...
extension IGPChatSetActionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatSetActionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
