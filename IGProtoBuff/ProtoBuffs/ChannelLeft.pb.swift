...
struct IGPChannelLeft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelLeft"
...
struct IGPChannelLeftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelLeftResponse"
...
extension IGPChannelLeft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelLeft) -> Bool {
...
extension IGPChannelLeftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelLeftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
