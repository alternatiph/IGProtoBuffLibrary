...
struct IGPGeoUpdatePosition: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGeoUpdatePosition"
...
struct IGPGeoUpdatePositionResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGeoUpdatePositionResponse"
...
extension IGPGeoUpdatePosition: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGeoUpdatePosition) -> Bool {
...
extension IGPGeoUpdatePositionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGeoUpdatePositionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
