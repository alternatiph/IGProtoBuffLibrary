...
struct IGPUserAvatarGetList: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserAvatarGetList"
...
struct IGPUserAvatarGetListResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserAvatarGetListResponse"
...
extension IGPUserAvatarGetList: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserAvatarGetList) -> Bool {
...
extension IGPUserAvatarGetListResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserAvatarGetListResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
