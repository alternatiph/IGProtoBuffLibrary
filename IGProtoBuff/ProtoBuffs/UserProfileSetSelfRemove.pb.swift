...
struct IGPUserProfileSetSelfRemove: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserProfileSetSelfRemove"
...
struct IGPUserProfileSetSelfRemoveResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserProfileSetSelfRemoveResponse"
...
extension IGPUserProfileSetSelfRemove: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserProfileSetSelfRemove) -> Bool {
...
extension IGPUserProfileSetSelfRemoveResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserProfileSetSelfRemoveResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
