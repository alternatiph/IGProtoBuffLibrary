...
struct IGPChannelAddAdmin: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAddAdmin"
...
struct IGPChannelAddAdminResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAddAdminResponse"
...
extension IGPChannelAddAdmin: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAddAdmin) -> Bool {
...
extension IGPChannelAddAdminResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAddAdminResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
