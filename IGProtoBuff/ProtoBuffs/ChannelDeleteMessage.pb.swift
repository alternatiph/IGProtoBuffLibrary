...
struct IGPChannelDeleteMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelDeleteMessage"
...
struct IGPChannelDeleteMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelDeleteMessageResponse"
...
extension IGPChannelDeleteMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelDeleteMessage) -> Bool {
...
extension IGPChannelDeleteMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelDeleteMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
