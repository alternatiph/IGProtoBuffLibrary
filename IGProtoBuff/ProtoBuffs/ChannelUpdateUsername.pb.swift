...
struct IGPChannelUpdateUsername: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelUpdateUsername"
...
struct IGPChannelUpdateUsernameResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelUpdateUsernameResponse"
...
extension IGPChannelUpdateUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelUpdateUsername) -> Bool {
...
extension IGPChannelUpdateUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelUpdateUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
