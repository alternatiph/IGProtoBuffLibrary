...
struct IGPGroupRevokeLink: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupRevokeLink"
...
struct IGPGroupRevokeLinkResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupRevokeLinkResponse"
...
extension IGPGroupRevokeLink: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupRevokeLink) -> Bool {
...
extension IGPGroupRevokeLinkResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupRevokeLinkResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
