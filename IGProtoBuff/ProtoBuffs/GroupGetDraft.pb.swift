...
struct IGPGroupGetDraft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupGetDraft"
...
struct IGPGroupGetDraftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupGetDraftResponse"
...
extension IGPGroupGetDraft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupGetDraft) -> Bool {
...
extension IGPGroupGetDraftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupGetDraftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
