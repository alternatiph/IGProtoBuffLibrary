...
struct IGPChannelKickMember: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickMember"
...
struct IGPChannelKickMemberResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickMemberResponse"
...
extension IGPChannelKickMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickMember) -> Bool {
...
extension IGPChannelKickMemberResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickMemberResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
