...
struct IGPGroupDeleteMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupDeleteMessage"
...
struct IGPGroupDeleteMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupDeleteMessageResponse"
...
extension IGPGroupDeleteMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupDeleteMessage) -> Bool {
...
extension IGPGroupDeleteMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupDeleteMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
