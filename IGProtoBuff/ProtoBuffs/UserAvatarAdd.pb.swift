...
struct IGPUserAvatarAdd: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserAvatarAdd"
...
struct IGPUserAvatarAddResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserAvatarAddResponse"
...
extension IGPUserAvatarAdd: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserAvatarAdd) -> Bool {
...
extension IGPUserAvatarAddResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserAvatarAddResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
