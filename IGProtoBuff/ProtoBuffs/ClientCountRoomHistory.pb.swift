...
struct IGPClientCountRoomHistory: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientCountRoomHistory"
...
struct IGPClientCountRoomHistoryResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientCountRoomHistoryResponse"
...
extension IGPClientCountRoomHistory: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientCountRoomHistory) -> Bool {
...
extension IGPClientCountRoomHistoryResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientCountRoomHistoryResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
