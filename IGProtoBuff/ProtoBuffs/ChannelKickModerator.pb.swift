...
struct IGPChannelKickModerator: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickModerator"
...
struct IGPChannelKickModeratorResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickModeratorResponse"
...
extension IGPChannelKickModerator: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickModerator) -> Bool {
...
extension IGPChannelKickModeratorResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickModeratorResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
