...
struct IGPUserContactsBlock: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserContactsBlock"
...
struct IGPUserContactsBlockResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserContactsBlockResponse"
...
extension IGPUserContactsBlock: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserContactsBlock) -> Bool {
...
extension IGPUserContactsBlockResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserContactsBlockResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
