...
struct IGPChannelRevokeLink: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelRevokeLink"
...
struct IGPChannelRevokeLinkResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelRevokeLinkResponse"
...
extension IGPChannelRevokeLink: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelRevokeLink) -> Bool {
...
extension IGPChannelRevokeLinkResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelRevokeLinkResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
