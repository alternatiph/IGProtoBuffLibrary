...
struct IGPChatSendMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatSendMessage"
...
struct IGPChatSendMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatSendMessageResponse"
...
extension IGPChatSendMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatSendMessage) -> Bool {
...
extension IGPChatSendMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatSendMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
