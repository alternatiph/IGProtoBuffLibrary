...
struct IGPGroupSendMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupSendMessage"
...
struct IGPGroupSendMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupSendMessageResponse"
...
extension IGPGroupSendMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupSendMessage) -> Bool {
...
extension IGPGroupSendMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupSendMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
