...
struct IGPGroupAddModerator: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddModerator"
...
struct IGPGroupAddModeratorResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddModeratorResponse"
...
extension IGPGroupAddModerator: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddModerator) -> Bool {
...
extension IGPGroupAddModeratorResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddModeratorResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
