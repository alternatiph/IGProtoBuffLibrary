...
struct IGPUserContactsUnblock: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserContactsUnblock"
...
struct IGPUserContactsUnblockResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserContactsUnblockResponse"
...
extension IGPUserContactsUnblock: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserContactsUnblock) -> Bool {
...
extension IGPUserContactsUnblockResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserContactsUnblockResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
