...
struct IGPUserProfileUpdateUsername: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserProfileUpdateUsername"
...
struct IGPUserProfileUpdateUsernameResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserProfileUpdateUsernameResponse"
...
extension IGPUserProfileUpdateUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserProfileUpdateUsername) -> Bool {
...
extension IGPUserProfileUpdateUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserProfileUpdateUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
