...
struct IGPChannelDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelDelete"
...
struct IGPChannelDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelDeleteResponse"
...
extension IGPChannelDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelDelete) -> Bool {
...
extension IGPChannelDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
