...
struct IGPGroupKickMember: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupKickMember"
...
struct IGPGroupKickMemberResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupKickMemberResponse"
...
extension IGPGroupKickMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupKickMember) -> Bool {
...
extension IGPGroupKickMemberResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupKickMemberResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
