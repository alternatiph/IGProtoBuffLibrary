...
struct IGPGeoGetConfiguration: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGeoGetConfiguration"
...
struct IGPGeoGetConfigurationResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGeoGetConfigurationResponse"
  ...
  var igpTileServer: [IGPGeoGetConfigurationResponse.IGPTileServer] {
  ...
  struct IGPTileServer: SwiftProtobuf.Message {
    static let protoMessageName: String = IGPGeoGetConfigurationResponse.protoMessageName + ".IGPTileServer"

    var igpBaseURL: String = String()
...
extension IGPGeoGetConfiguration: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGeoGetConfiguration) -> Bool {
...
extension IGPGeoGetConfigurationResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGeoGetConfigurationResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
...
extension IGPGeoGetConfigurationResponse.IGPTileServer: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGeoGetConfigurationResponse.IGPTileServer) -> Bool {
