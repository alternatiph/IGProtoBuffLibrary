...
struct IGPChannelSendMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelSendMessage"
...
struct IGPChannelSendMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelSendMessageResponse"
  ...
  var igpRoomMessage: IGPRoomMessage {
  ...
  var hasIgpRoomMessage: Bool {return _storage._igpRoomMessage != nil}
  /// Clears the value of `igpRoomMessage`. Subsequent reads from it will return its default value.
  mutating func clearIgpRoomMessage() {_storage._igpRoomMessage = nil}
...
extension IGPChannelSendMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelSendMessage) -> Bool {
...
extension IGPChannelSendMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelSendMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
