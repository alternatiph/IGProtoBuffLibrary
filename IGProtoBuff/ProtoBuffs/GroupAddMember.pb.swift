...
struct IGPGroupAddMember: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddMember"
  ...
  var igpMember: IGPGroupAddMember.IGPMember {
  ...
  struct IGPMember: SwiftProtobuf.Message {
    static let protoMessageName: String = IGPGroupAddMember.protoMessageName + ".IGPMember"

    var igpUserID: Int64 = 0

    var igpStartMessageID: Int64 = 0
...
struct IGPGroupAddMemberResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddMemberResponse"
...
extension IGPGroupAddMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddMember) -> Bool {
...
extension IGPGroupAddMember.IGPMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddMember.IGPMember) -> Bool {
...
extension IGPGroupAddMemberResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddMemberResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
