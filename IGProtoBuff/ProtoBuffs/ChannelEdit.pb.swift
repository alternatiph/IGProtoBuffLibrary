...
struct IGPChannelEdit: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelEdit"
...
struct IGPChannelEditResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelEditResponse"
...
extension IGPChannelEdit: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelEdit) -> Bool {
...
extension IGPChannelEditResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelEditResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
