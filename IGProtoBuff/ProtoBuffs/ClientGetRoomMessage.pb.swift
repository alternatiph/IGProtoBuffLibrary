...
struct IGPClientGetRoomMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoomMessage"
...
struct IGPClientGetRoomMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoomMessageResponse"
  ...
  var hasIgpMessage: Bool {return _storage._igpMessage != nil}
  /// Clears the value of `igpMessage`. Subsequent reads from it will return its default value.
  mutating func clearIgpMessage() {_storage._igpMessage = nil}
...
extension IGPClientGetRoomMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoomMessage) -> Bool {
...
extension IGPClientGetRoomMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoomMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
