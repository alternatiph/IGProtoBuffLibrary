...
struct IGPChatDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatDelete"
...
struct IGPChatDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatDeleteResponse"
...
extension IGPChatDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatDelete) -> Bool {
...
extension IGPChatDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
