...
struct IGPPushLoginTokenResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPPushLoginTokenResponse"
...
extension IGPPushLoginTokenResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPPushLoginTokenResponse) -> Bool {
