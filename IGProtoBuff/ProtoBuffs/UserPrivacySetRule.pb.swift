...
struct IGPUserPrivacySetRule: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserPrivacySetRule"
...
struct IGPUserPrivacySetRuleResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserPrivacySetRuleResponse"
...
extension IGPUserPrivacySetRule: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserPrivacySetRule) -> Bool {
...
extension IGPUserPrivacySetRuleResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserPrivacySetRuleResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
