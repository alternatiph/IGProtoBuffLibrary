...
struct IGPChannelCreate: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelCreate"
...
struct IGPChannelCreateResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelCreateResponse"
...
extension IGPChannelCreate: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelCreate) -> Bool {
...
extension IGPChannelCreateResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelCreateResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
