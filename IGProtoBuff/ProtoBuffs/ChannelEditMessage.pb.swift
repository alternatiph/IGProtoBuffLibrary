...
struct IGPChannelEditMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelEditMessage"
...
struct IGPChannelEditMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelEditMessageResponse"
...
extension IGPChannelEditMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelEditMessage) -> Bool {
...
extension IGPChannelEditMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelEditMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
