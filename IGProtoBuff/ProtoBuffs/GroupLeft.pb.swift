...
struct IGPGroupLeft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupLeft"
...
struct IGPGroupLeftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupLeftResponse"
...
extension IGPGroupLeft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupLeft) -> Bool {
...
extension IGPGroupLeftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupLeftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
