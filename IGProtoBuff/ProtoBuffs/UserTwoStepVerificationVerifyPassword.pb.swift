...
struct IGPUserTwoStepVerificationVerifyPassword: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserTwoStepVerificationVerifyPassword"
...
struct IGPUserTwoStepVerificationVerifyPasswordResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserTwoStepVerificationVerifyPasswordResponse"
...
extension IGPUserTwoStepVerificationVerifyPassword: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserTwoStepVerificationVerifyPassword) -> Bool {
...
extension IGPUserTwoStepVerificationVerifyPasswordResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserTwoStepVerificationVerifyPasswordResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
