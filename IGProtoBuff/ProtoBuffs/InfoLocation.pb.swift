...
struct IGPInfoLocation: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPInfoLocation"
...
struct IGPInfoLocationResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPInfoLocationResponse"
...
extension IGPInfoLocation: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPInfoLocation) -> Bool {
...
extension IGPInfoLocationResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPInfoLocationResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
