...
struct IGPChannelGetDraft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelGetDraft"
...
struct IGPChannelGetDraftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelGetDraftResponse"
...
extension IGPChannelGetDraft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelGetDraft) -> Bool {
...
extension IGPChannelGetDraftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelGetDraftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
