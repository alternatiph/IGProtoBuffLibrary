...
struct IGPChannelAvatarGetList: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAvatarGetList"
...
struct IGPChannelAvatarGetListResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAvatarGetListResponse"
...
extension IGPChannelAvatarGetList: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAvatarGetList) -> Bool {
...
extension IGPChannelAvatarGetListResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAvatarGetListResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
