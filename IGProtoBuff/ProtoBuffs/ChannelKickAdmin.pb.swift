...
struct IGPChannelKickAdmin: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickAdmin"
...
struct IGPChannelKickAdminResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelKickAdminResponse"
...
extension IGPChannelKickAdmin: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickAdmin) -> Bool {
...
extension IGPChannelKickAdminResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelKickAdminResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
