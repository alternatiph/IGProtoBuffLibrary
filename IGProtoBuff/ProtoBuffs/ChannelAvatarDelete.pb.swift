...
struct IGPChannelAvatarDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAvatarDelete"
...
struct IGPChannelAvatarDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAvatarDeleteResponse"
...
extension IGPChannelAvatarDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAvatarDelete) -> Bool {
...
extension IGPChannelAvatarDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAvatarDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
