...
struct IGPQrCodeAddMe: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPQrCodeAddMe"
...
struct IGPQrCodeAddMeResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPQrCodeAddMeResponse"
...
extension IGPQrCodeAddMe: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPQrCodeAddMe) -> Bool {
...
extension IGPQrCodeAddMeResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPQrCodeAddMeResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
