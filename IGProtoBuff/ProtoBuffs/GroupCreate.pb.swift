...
struct IGPGroupCreate: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupCreate"
...
struct IGPGroupCreateResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupCreateResponse"
...
extension IGPGroupCreate: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupCreate) -> Bool {
...
extension IGPGroupCreateResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupCreateResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
