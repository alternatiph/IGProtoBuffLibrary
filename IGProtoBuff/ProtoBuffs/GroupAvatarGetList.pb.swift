...
struct IGPGroupAvatarGetList: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarGetList"
...
struct IGPGroupAvatarGetListResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarGetListResponse"
...
extension IGPGroupAvatarGetList: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarGetList) -> Bool {
...
extension IGPGroupAvatarGetListResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarGetListResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
