...
struct IGPGroupSetAction: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupSetAction"
...
struct IGPGroupSetActionResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupSetActionResponse"
...
extension IGPGroupSetAction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupSetAction) -> Bool {
...
extension IGPGroupSetActionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupSetActionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
