...
struct IGPGroupEdit: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupEdit"
...
struct IGPGroupEditResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupEditResponse"
...
extension IGPGroupEdit: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupEdit) -> Bool {
...
extension IGPGroupEditResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupEditResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
