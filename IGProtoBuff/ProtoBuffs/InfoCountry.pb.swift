...
struct IGPInfoCountry: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPInfoCountry"
...
struct IGPInfoCountryResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPInfoCountryResponse"
...
extension IGPInfoCountry: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPInfoCountry) -> Bool {
...
extension IGPInfoCountryResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPInfoCountryResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
