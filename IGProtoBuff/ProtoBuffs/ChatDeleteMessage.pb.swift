...
struct IGPChatDeleteMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatDeleteMessage"
...
struct IGPChatDeleteMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatDeleteMessageResponse"
...
extension IGPChatDeleteMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatDeleteMessage) -> Bool {
...
extension IGPChatDeleteMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatDeleteMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
