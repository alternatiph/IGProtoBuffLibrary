...
struct IGPChannelSetAction: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelSetAction"
...
struct IGPChannelSetActionResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelSetActionResponse"
...
extension IGPChannelSetAction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelSetAction) -> Bool {
...
extension IGPChannelSetActionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelSetActionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
