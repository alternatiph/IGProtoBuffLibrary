...
struct IGPChatConvertToGroup: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatConvertToGroup"
...
struct IGPChatConvertToGroupResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatConvertToGroupResponse"
...
extension IGPChatConvertToGroup: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatConvertToGroup) -> Bool {
...
extension IGPChatConvertToGroupResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatConvertToGroupResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
