...
struct IGPGroupAddAdmin: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddAdmin"
...
struct IGPGroupAddAdminResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAddAdminResponse"
...
extension IGPGroupAddAdmin: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddAdmin) -> Bool {
...
extension IGPGroupAddAdminResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAddAdminResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
