...
struct IGPChannelUpdateSignature: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelUpdateSignature"
...
struct IGPChannelUpdateSignatureResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelUpdateSignatureResponse"
...
extension IGPChannelUpdateSignature: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelUpdateSignature) -> Bool {
...
extension IGPChannelUpdateSignatureResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelUpdateSignatureResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
