...
struct IGPGroupAvatarAdd: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarAdd"
...
struct IGPGroupAvatarAddResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarAddResponse"
...
extension IGPGroupAvatarAdd: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarAdd) -> Bool {
...
extension IGPGroupAvatarAddResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarAddResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
