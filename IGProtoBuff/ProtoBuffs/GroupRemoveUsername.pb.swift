...
struct IGPGroupRemoveUsername: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupRemoveUsername"
...
struct IGPGroupRemoveUsernameResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupRemoveUsernameResponse"
...
extension IGPGroupRemoveUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupRemoveUsername) -> Bool {
...
extension IGPGroupRemoveUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupRemoveUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
