...
struct IGPUserVerify: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserVerify"
...
struct IGPUserVerifyResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserVerifyResponse"
...
extension IGPUserVerify: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserVerify) -> Bool {
...
extension IGPUserVerifyResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserVerifyResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
