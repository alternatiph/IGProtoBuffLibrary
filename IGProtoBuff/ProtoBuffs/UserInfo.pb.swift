...
struct IGPUserInfo: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserInfo"
...
struct IGPUserInfoResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserInfoResponse"
...
extension IGPUserInfo: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserInfo) -> Bool {
...
extension IGPUserInfoResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserInfoResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
