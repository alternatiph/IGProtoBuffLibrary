...
struct IGPUserVerifyNewDevice: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserVerifyNewDevice"
...
struct IGPUserVerifyNewDeviceResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserVerifyNewDeviceResponse"
  ...
  var igpTwoStepVerification: Bool {
...
extension IGPUserVerifyNewDevice: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserVerifyNewDevice) -> Bool {
...
extension IGPUserVerifyNewDeviceResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserVerifyNewDeviceResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
