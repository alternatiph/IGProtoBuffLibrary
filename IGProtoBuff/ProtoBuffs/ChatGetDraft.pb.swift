...
struct IGPChatGetDraft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatGetDraft"
...
struct IGPChatGetDraftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatGetDraftResponse"
...
extension IGPChatGetDraft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatGetDraft) -> Bool {
...
extension IGPChatGetDraftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatGetDraftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
