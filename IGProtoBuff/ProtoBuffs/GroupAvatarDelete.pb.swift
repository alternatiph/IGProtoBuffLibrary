...
struct IGPGroupAvatarDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarDelete"
...
struct IGPGroupAvatarDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupAvatarDeleteResponse"
...
extension IGPGroupAvatarDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarDelete) -> Bool {
...
extension IGPGroupAvatarDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupAvatarDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
