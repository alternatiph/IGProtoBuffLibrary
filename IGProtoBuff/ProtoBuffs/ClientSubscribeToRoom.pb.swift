...
struct IGPClientSubscribeToRoom: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientSubscribeToRoom"
...
struct IGPClientSubscribeToRoomResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientSubscribeToRoomResponse"
...
extension IGPClientSubscribeToRoom: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientSubscribeToRoom) -> Bool {
...
extension IGPClientSubscribeToRoomResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientSubscribeToRoomResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
