...
struct IGPClientJoinByUsername: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientJoinByUsername"
...
struct IGPClientJoinByUsernameResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientJoinByUsernameResponse"
...
extension IGPClientJoinByUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientJoinByUsername) -> Bool {
...
extension IGPClientJoinByUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientJoinByUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
