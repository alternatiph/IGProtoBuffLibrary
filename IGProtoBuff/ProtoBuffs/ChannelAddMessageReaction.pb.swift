...
struct IGPChannelAddMessageReaction: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAddMessageReaction"
  ...
  var igpReaction: IGPRoomMessageReaction {
...
struct IGPChannelAddMessageReactionResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelAddMessageReactionResponse"
  ...
  var igpReactionCounterLabel: String {
...
extension IGPChannelAddMessageReaction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAddMessageReaction) -> Bool {
...
extension IGPChannelAddMessageReactionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelAddMessageReactionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
