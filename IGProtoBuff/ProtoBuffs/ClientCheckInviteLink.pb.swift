...
struct IGPClientCheckInviteLink: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientCheckInviteLink"
...
struct IGPClientCheckInviteLinkResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientCheckInviteLinkResponse"
...
extension IGPClientCheckInviteLink: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientCheckInviteLink) -> Bool {
...
extension IGPClientCheckInviteLinkResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientCheckInviteLinkResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
