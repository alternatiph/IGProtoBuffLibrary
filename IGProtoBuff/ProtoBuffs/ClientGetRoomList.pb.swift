...
struct IGPClientGetRoomList: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoomList"
...
struct IGPClientGetRoomListResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoomListResponse"
...
extension IGPClientGetRoomList: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoomList) -> Bool {
...
extension IGPClientGetRoomListResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoomListResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
