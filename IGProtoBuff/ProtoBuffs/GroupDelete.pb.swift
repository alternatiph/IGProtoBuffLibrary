...
struct IGPGroupDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupDelete"
...
struct IGPGroupDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupDeleteResponse"
...
extension IGPGroupDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupDelete) -> Bool {
...
extension IGPGroupDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
