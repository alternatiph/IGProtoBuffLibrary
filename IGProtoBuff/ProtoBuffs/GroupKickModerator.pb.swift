...
struct IGPGroupKickModerator: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupKickModerator"
...
struct IGPGroupKickModeratorResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupKickModeratorResponse"
...
extension IGPGroupKickModerator: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupKickModerator) -> Bool {
...
extension IGPGroupKickModeratorResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupKickModeratorResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
