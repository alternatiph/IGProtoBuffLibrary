...
struct IGPChannelCheckUsername: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelCheckUsername"
...
struct IGPChannelCheckUsernameResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChannelCheckUsernameResponse"
  ...
  var igpStatus: IGPChannelCheckUsernameResponse.IGPStatus {
...
extension IGPChannelCheckUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelCheckUsername) -> Bool {
...
extension IGPChannelCheckUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChannelCheckUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
