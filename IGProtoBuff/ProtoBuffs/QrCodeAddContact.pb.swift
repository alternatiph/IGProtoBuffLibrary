...
struct IGPQrCodeAddContact: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPQrCodeAddContact"
...
struct IGPQrCodeAddContactResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPQrCodeAddContactResponse"
...
extension IGPQrCodeAddContact: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPQrCodeAddContact) -> Bool {
...
extension IGPQrCodeAddContactResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPQrCodeAddContactResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
