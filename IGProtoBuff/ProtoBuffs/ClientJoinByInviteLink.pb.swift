...
struct IGPClientJoinByInviteLink: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientJoinByInviteLink"
...
struct IGPClientJoinByInviteLinkResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientJoinByInviteLinkResponse"
...
extension IGPClientJoinByInviteLink: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientJoinByInviteLink) -> Bool {
...
extension IGPClientJoinByInviteLinkResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientJoinByInviteLinkResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
