...
struct IGPUserDelete: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserDelete"
  ...
  var igpReason: IGPUserDelete.IGPReason {
  ...
  enum IGPReason: SwiftProtobuf.Enum {
...
struct IGPUserDeleteResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPUserDeleteResponse"
...
extension IGPUserDelete: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserDelete) -> Bool {
...
extension IGPUserDeleteResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPUserDeleteResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
