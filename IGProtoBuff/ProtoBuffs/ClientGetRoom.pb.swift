...
struct IGPClientGetRoom: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoom"
...
struct IGPClientGetRoomResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPClientGetRoomResponse"
...
extension IGPClientGetRoom: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoom) -> Bool {
...
extension IGPClientGetRoomResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPClientGetRoomResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
