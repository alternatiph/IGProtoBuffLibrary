...
struct IGPGroupEditMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupEditMessage"
...
struct IGPGroupEditMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupEditMessageResponse"
...
extension IGPGroupEditMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupEditMessage) -> Bool {
...
extension IGPGroupEditMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupEditMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
