...
struct IGPChatUpdateDraft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatUpdateDraft"
...
struct IGPChatUpdateDraftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatUpdateDraftResponse"
...
extension IGPChatUpdateDraft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatUpdateDraft) -> Bool {
...
extension IGPChatUpdateDraftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatUpdateDraftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
