...
struct IGPChatEditMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatEditMessage"
...
struct IGPChatEditMessageResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPChatEditMessageResponse"
...
extension IGPChatEditMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatEditMessage) -> Bool {
...
extension IGPChatEditMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPChatEditMessageResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
