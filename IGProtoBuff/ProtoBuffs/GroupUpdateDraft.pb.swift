...
struct IGPGroupUpdateDraft: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupUpdateDraft"
...
struct IGPGroupUpdateDraftResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = "IGPGroupUpdateDraftResponse"
...
extension IGPGroupUpdateDraft: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupUpdateDraft) -> Bool {
...
extension IGPGroupUpdateDraftResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: IGPGroupUpdateDraftResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
